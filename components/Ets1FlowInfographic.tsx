...
import infographicDe from "@/assets/ets-1-infographic-de.png";
import infographicEn from "@/assets/ets-1-infographic-en.png";
...
export function Ets1FlowInfographic({ locale, alt, caption, enlargeLabel, closeLabel }: Props) {
