...
import infographicDe from "@/assets/thg-quote-rfnbo-infographic-de.png";
import infographicEn from "@/assets/thg-quote-rfnbo-infographic-en.png";
...
export function ThgQuoteRevenueInfographic({ locale, alt, caption, enlargeLabel, closeLabel }: Props) {
