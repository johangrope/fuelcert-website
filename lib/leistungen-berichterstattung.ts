...
export const BERICHTERSTATTUNG_SERVICE_GROUPS: readonly ServiceBulletGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Vorbereitung und fachliche Begleitung der jährlichen Emissionsberichterstattung",
      "Vorbereitung und Begleitung der Verifizierung durch die Prüfstelle",
      "Abstimmung mit Prüfstelle und DEHSt",
      "Unterstützung bei Konten und Prozessen im Unionsregister",
      "Unterstützung bei der fristgerechten Abgabe von Emissionsberechtigungen",
      "Regelkonforme Einordnung und Berücksichtigung abzugsfähiger Brennstoffe und Brennstoffanteile, z. B. Biomasse, Biomethan, RFNBO oder Abfallbrennstoffe",
      "Unterstützung bei der regulatorisch sauberen Vermeidung von Doppelbelastungen und bei der Abgrenzung zum nEHS",
    ],
  },
  {
    heading: "nEHS",
    items: [
      ...
      "Unterstützung bei der fristgerechten Abgabe von nEHS-Zertifikaten",
      "Abstimmung mit DEHSt und Prüfstelle",
      "Regelkonforme Einordnung und Berücksichtigung abzugsfähiger erneuerbarer Kraft- und Brennstoffe sowie biogener Brennstoffanteile",
      "Unterstützung bei der regulatorisch sauberen Vermeidung von Doppelbelastungen und bei der Abgrenzung zu EU-ETS I",
    ],
  },
] as const;
