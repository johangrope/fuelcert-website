export const NEHS_SEO = {
  title: "Nationaler Emissionshandel (nEHS): BEHG, Überwachungsplan und nEZ | FuelCert",
  metaDescription:
    "Nationaler Emissionshandel (nEHS) nach BEHG: FuelCert unterstützt bei Betroffenheit, Überwachungsplan, Emissionsbericht, nEHS-Register, nEZ-Erwerb und Abgabe – sowie bei erneuerbaren Brennstoffen.",
  h1: "Nationaler Emissionshandel (nEHS)",
} as const;
...
export const NEHS_INTRO_VISUAL = {
  alt: "Industrielle Brennstofflogistik und Emissionsmonitoring im nationalen Emissionshandel",
  caption:
...
export const NEHS_ECONOMIC = {
  heading: "Warum der nationale Emissionshandel wirtschaftlich relevant ist",
  paragraphs: [
...
export const NEHS_SUPPORT = {
  heading: "FuelCert unterstützt im gesamten nEHS-Prozess",
  intro: "Unternehmen im nEHS stehen vor einem durchgängigen regulatorischen Prozess. FuelCert begleitet sachlich und strukturiert:",
  bullets: [
...
export const NEHS_RENEWABLES = {
  heading: "Erneuerbare Kraft- und Brennstoffe im nEHS",
  paragraphs: [
...
export const NEHS_OBLIGATIONS = {
  heading: "Pflichten, Fristen und Register im Überblick",
  bullets: [
...
export const NEHS_INTERFACES = {
  heading: "Doppelerfassung, Doppelbelastung und Schnittstellen",
  paragraphs: [
...
export const NEHS_IMPLEMENTATION = {
  heading: "Was in der Umsetzung zählt",
  paragraphs: [
...
export const NEHS_FLOW = {
  heading: "So funktioniert der nationale Emissionshandel in der Praxis",
  intro:
  ...
  figure: {
    alt: "Ablauf des nationalen Emissionshandels: Betroffenheit, Überwachungsplan, Nachweise, Emissionsbericht, Register und nEZ-Abgabe",
    caption:
  ...
  dehstLink: {
    label: "Zur offiziellen DEHSt-Informationsseite zum nationalen Emissionshandel",
    hint: "Offizielle Informationen der Deutschen Emissionshandelsstelle zum nEHS nach dem BEHG.",
