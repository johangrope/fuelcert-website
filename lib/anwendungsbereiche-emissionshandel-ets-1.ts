export const ETS1_SEO = {
  title: "Emissionshandel (EU-ETS I): Beratung zu Überwachungsplan, Emissionsbericht und EUA | FuelCert",
  metaDescription:
    "EU-ETS I für Betreiber emissionshandelspflichtiger Anlagen: FuelCert unterstützt bei Überwachungsplan, Emissionsbericht, Verifizierung, Unionsregister, EUA-Beschaffung und EUA-Abgabe – sowie bei nachhaltigen Brennstoffen, kostenloser Zuteilung und CBAM.",
  h1: "Emissionshandel (EU-ETS I)",
} as const;
...
export const ETS1_INTRO_VISUAL = {
  alt: "Industrieanlage im EU-ETS I mit Emissionsüberwachung und digitaler Datenerfassung",
  caption:
...
export const ETS1_ECONOMIC = {
  heading: "Warum der EU-ETS I wirtschaftlich relevant ist",
  paragraphs: [
...
export const ETS1_SUPPORT = {
  heading: "FuelCert unterstützt im gesamten ETS-I-Prozess",
  intro:
...
export const ETS1_SUSTAINABLE_FUELS = {
  heading: "Nachhaltige Brennstoffe und abzugsfähige Anteile im EU-ETS I",
  paragraphs: [
...
export const ETS1_FREE_ALLOCATION = {
  heading: "Kostenlose Zuteilung im EU-ETS I",
  paragraphs: [
...
export const ETS1_CBAM = {
  heading: "CBAM als angrenzendes Thema",
  paragraphs: [
...
export const ETS1_FLOW = {
  heading: "So funktioniert der EU-ETS I in der Praxis",
  intro:
  ...
  blocks: [
    {
      heading: "Der Prozess im Überblick",
      paragraphs: [
    ...
    {
      heading: "Wirtschaftlicher Hebel nachhaltiger Brennstoffe",
      paragraphs: [
  ...
  figure: {
    alt: "Schematische Darstellung des Ablaufs im EU-ETS I von Brennstoffeinsatz, Überwachungsplan und Nachweisen bis Emissionsbericht, EUA-Abgabe und reduzierten ETS-Kosten durch nachhaltige Brennstoffe.",
    caption:
  ...
  dehstLink: {
    label: "Zur DEHSt-Informationsseite zum EU-ETS I",
    hint: "Offizielle Informationen der Deutschen Emissionshandelsstelle zu stationären Anlagen im EU-ETS I.",
...
export const ETS1_CTA = {
  ...
  actions: [{ label: "Erstgespräch vereinbaren", href: "/kontakt", variant: "primary" as const }],
} as const;
