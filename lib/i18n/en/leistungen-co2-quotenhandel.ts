...
export const CO2_QUOTENHANDEL_SECTIONS = [
  ...
  {
    heading: "What revenue does my product generate – and why?",
    paragraphs: [
      "Revenue from CO₂ and quota markets depends on regulatory eligibility, proof quality, demand and the respective market mechanisms. FuelCert helps assess marketing options and revenue potential realistically – based on robust data, clear rules and current market conditions, not vague promises.",
    ],
  },
  {
    heading: "Support with trades and contract terms",
    paragraphs: [
      "FuelCert supports preparation and expert structuring of commercial transactions in the quota and certificate environment. This includes classification of customary contract mechanisms and terms from the perspective of market logic, proof management and regulatory implementation – grounded in practice, not generic consulting language.",
      "FuelCert is not a law firm and does not provide legal advice. We assess contract content from a technical and market perspective; for legal evaluation, please consult your legal advisers.",
    ],
    mutedFromIndex: 1,
  },
] as const;
...
export const CO2_QUOTENHANDEL_CTA = {
  heading: "Want a robust assessment of your product's market opportunities?",
  text: "Talk to us about your starting position – we clarify markets, marketing options and sensible next steps.",
} as const;
